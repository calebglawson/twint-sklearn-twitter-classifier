# !! Due to recent changes on Twitter, twint is not able to fetch user ids. Things are broken right now. [twint#767](https://github.com/twintproject/twint/issues/767) !!
